...
{description} Položka uložit slouží pro uložení stávajícího stavu aplikace do souboru s koncovkou .drd. Pokud v aplikaci byl otevřen soubor .drd, po zvolení možnosti uložit se stávají stav aplikace uloží do stejného souboru, ze kterého byl otevřen. Pokud již bylo dobrodružství uloženo do konkrétního souboru, aktuální stav se automaticky uloží do tohoto souboru. Pokud ani jedna z těchto možností se nestala, volba uložit se zachová stejně jako možnost Uložit jako
	...
	\begin{description}
		\item[Kouzla (Alt+1)] Editace šablon kouzle
		\item[Předměty (Alt+2)] Editace šablon předmětů
		\item[Schopnosti (Alt+3)] Editace šablon schopností
		\item[Kontext pro schopností (Alt+4)] Editace šablon pro kontext schopností
		\item[Efekty (Alt+5)] Editace šablon efektů
		\item[Modifikátory (Alt+6)] Editace šablon modifikátorů
		\item[Postavy (Alt+7)] Editace postav
		\item[Příšery (Alt+8)] Editace šablon příšer
		\item[Dobrodružství (Alt+9)] Editace dobrodružství
		\item[Lokace (Alt+0)] Editace šablon lokací
		\item[Map (Alt+=)] Editace map
	\end{description}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
