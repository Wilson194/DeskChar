...
\abstractCS{Cílem této práce je hráčům Dračího doupěte, a zejména Pánu jeskyně, usnadnit vytváření dobrodružství, postav a předmětů pomocí jednoduché desktopové aplikace. Hlavní výhodou aplikace je možnost exportování dobrodružství pro mobilní aplikaci MobChar pro Pána jeskyně a exportování do přehledného HTML formátu vhodné pro tisk a hraní Dračího doupěte bez mobilů a jiných zařízení. V práci byla vytvořena aplikace, ve které je možné pomocí grafického rozhraní vytvářet rozsáhlá dobrodružství plná lokací, map, předmětů, nestvůr a mnohého dalšího. \par

V první části je vypracovaná důkladná analýza problém a již existujících aplikací. Na základě analýzy je vytvořen návrh aplikace, který se převážně zaměřuje na nejdůležitější funkcionalitu aplikace, což je tvorba XML a HTML výstupních souborů. \par

Na základě analýzy a návrhu je vytvořena implementace aplikace. V poslední fázi je aplikace důkladně otestována, aby byla zaručena výsledná kvalita a splnění požadavků. \par

Všechny zdrojové kódy, dokumentace, spustitelný program a uživatelská příručka jsou umístěné na přiloženém CD.
...
\keywordsEN{desktop application, heroes games, MobChar, Dračí doupě, extension, desktop games, scenario creation, Python, SQLite, XML}
...
Vzniklá aplikace je pouze ve verzi 1.0 a má velký potenciál pro zlepšování. Hlavní směr vývoje pro verzi 2.0 by se měl týkat mapy. Ve verzi 1.0 je editor mapy pouze základní a aplikace zde nabízí velké množství pro zlepšení. 
