...
\begin{figure}\centering
	...
	\caption[Usecase šablony]{Ukázkový obrázek v~plovoucím prostředí}\label{fig:float}
\end{figure}

Případ užití týkající se práci se šablonami namodelovaný na obrázku \ref{fig:float} je oddělený od ostatních, protože obsahuje veškeré činnosti, které od aplikace vyžaduje hráč. Jedná se o~veškerou práci se šablonami pro mobilní aplikaci MobChar.\\
\\
\textbf{Práce se šablonami:} uživatel si bude moci vytvořit nové šablony nebo editovat stávající. Veškeré parametry, které je možné do xml šablony zapsat, lze jednoduše upravovat\\
\\
\textbf{Import šablon z XML souboru:} program bude umožňovat import šablon ze strukturovaných xml souborů, které vytváří mobilní aplikace MobChar a samotný program. Importované šablony se přidají do databáze.\\
\\
\textbf{Sdružování šablon do skupin:} veškeré šablony půjde rozřazovat do stromové struktury pro větší přehlednost, pomocí vytváření složek a jednoduchého drag and drop systému. Takto rozřazené šablony budou umožňovat přehlednější práci a export do xml souborů.\\
\\
\textbf{Export šablon pro mobilní aplikaci:} program bude umožňovat vytvářet xml soubory ve formátu, se kterým umí pracovat mobilní aplikace MobChar. Lze vyexportovat veškeré šablony do jednoho souboru nebo vybrat, které šablony se mají exportovat.\\
\\
\textbf{Export šablon do pdf pro tisknutí:} veškeré šablony je možné exportovat do formátu pdf, které je vhodné a přehledné pro tisk.\\
\\
\textbf{Tvorba překladů šablon:} každá šablona může být přeložena do libovolného počtu jazyků. Při exportu šablon se všechny jazykové překlady exportují.\\
\\
